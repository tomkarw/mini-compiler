...
"("				{ yylval = new SyntaxInfo(yyline, yycol, yytext); return (int)Tokens.BOPEN;			}
")"				{ yylval = new SyntaxInfo(yyline, yycol, yytext); return (int)Tokens.BCLOSE;			}
"{"				{ yylval = new SyntaxInfo(yyline, yycol, yytext); return (int)Tokens.POPEN;			}
"}"				{ yylval = new SyntaxInfo(yyline, yycol, yytext); return (int)Tokens.PCLOSE;			}
